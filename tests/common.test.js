...
describe('test common', function() {
    ...
    describe('common.when', function() {
        ...
        test('when成功', function() {
            ...
            return common.when([deferred1.promise, deferred2.promise]).then(function(data) {
        ...
        test('when失败', function() {
            ...
            return common.when([deferred3.promise, deferred4.promise]).then(function() {},function(data) {
